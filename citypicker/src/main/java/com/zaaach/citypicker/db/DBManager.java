...
import static com.zaaach.citypicker.db.DBConfig.COLUMN_PRO_ID;
import static com.zaaach.citypicker.db.DBConfig.HISTORY_TABLE;
...
public class DBManager {
    ...
    public List<City> getAllCities(){
        ...
        while (cursor.moveToNext()){
            ...
            String provinceId = cursor.getString(cursor.getColumnIndex(COLUMN_PRO_ID));
            city = new City(name, province, pinyin, code,provinceId);
            result.add(city);
        }
        cursor.close();
        db.close();
    ...
    public List<City> getAllHistory(){
        SQLiteDatabase db = SQLiteDatabase.openOrCreateDatabase(DB_PATH + LATEST_DB_NAME, null);
    ...
    public List<City> searchCity(final String keyword){
        ...
        while (cursor.moveToNext()){
            ...
            String code = cursor.getString(cursor.getColumnIndex(COLUMN_C_CODE));
            String provinceId = cursor.getString(cursor.getColumnIndex(COLUMN_PRO_ID));
            City city = new City(name, province, pinyin, code,provinceId);
            result.add(city);
        }
        cursor.close();
        db.close();
    ...
    public List<City> searchAllCityByProId(String proId){
//        String sql = "select * from "+TABLE_NAME+" where "+COLUMN_PRO_ID+" ="+"\"proId\"";
        String sql = "select * from "+TABLE_NAME+" where "+COLUMN_PRO_ID+" = ? ";
        SQLiteDatabase db = SQLiteDatabase.openOrCreateDatabase(DB_PATH + LATEST_DB_NAME, null);
    ...
    public List<City> singleConditonQuery(String column,String value){
        String sql = "select * from " + TABLE_NAME + " where "
                +column+" = ? ";
        SQLiteDatabase db = SQLiteDatabase.openOrCreateDatabase(DB_PATH + LATEST_DB_NAME, null);
